...
network-manager-docker:
	...
	docker buildx build --push --platform linux/arm64,linux/amd64 -t ralfeus/network-manager:stable -t ralfeus/network-manager:$(TAG) . -f network_manager/Dockerfile
	docker buildx build --push --platform linux/arm64,linux/amd64 -t ralfeus/network-builder:stable -t ralfeus/network-builder:$(TAG) . -f network_builder/Dockerfile