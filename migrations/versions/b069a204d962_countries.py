...
Revision ID: b069a204d962
Revises: 843f63adf3b9
Create Date: 2020-08-17 10:40:48.313733
...
revision = 'b069a204d962'
down_revision = '843f63adf3b9'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    tbl_countries = op.create_table('countries',
    sa.Column('id', sa.String(length=2), nullable=False),
    sa.Column('name', sa.String(length=64), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    # ### end Alembic commands ###
    op.bulk_insert(tbl_countries, countries)
