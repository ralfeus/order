...
# from app.payments.forms.payment import PaymentForm
...
def create_payment():
    ...
    #     try:
    #         db.session.commit()
    #         flash("The payment is created", category='info')
    #         return redirect('/wallet')
    #     except Exception as e:
    #         flash(f"The payment couldn't be created. {e}", category="error")
    return render_template('payment.html', title="Create payment") #, form=form)
