...
bp_api_admin = Blueprint('packer_api_admin', __name__,
                         url_prefix='/api/v1/admin/order/packer')
bp_client_admin = Blueprint('packer_client_admin', __name__,
                            url_prefix='/admin/order/packers', template_folder='templates')
bp_api_user = Blueprint('packer_api_user', __name__,
                         url_prefix='/api/v1/packer')
bp_client_user = Blueprint('packer_client_user', __name__,
                            url_prefix='/packer', template_folder='templates')
