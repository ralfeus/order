...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = 'mysql+mysqldb://maryna:maryna@localhost/order-master?auth_plugin=mysql_native_password'
    # SQLALCHEMY_DATABASE_URI = 'mysql+mysqldb://dina:dina@mgmt-2.ralfeus.eu/dina?auth_plugin=mysql_native_password'
    ...
    SELENIUM_DRIVER = '/usr/local/bin/chromedriver'
    #SELENIUM_LOG_PATH = 'chromedriver.dev.log'
...
class TestConfig(Config):
    ...
    SELENIUM_DRIVER = '/usr/local/bin/chromedriver'
    SELENIUM_LOG_PATH = 'chromedriver.test.log'
