...
user_create_sale_order_rendering = signals.signal('sale_order.user_create_order.rendering')
...
__all__ = [
    sale_order_created, sale_order_packed, sale_order_shipped, admin_order_products_rendering,
